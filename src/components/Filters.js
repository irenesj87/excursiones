	...
	return (
		<Col xs="12" md="3" lg="2">
			<Accordion flush className={styles.customAccordion}>
				<Accordion.Item eventKey="0" className={styles.customAccordionItem}>
